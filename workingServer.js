...
// Initialize with GUARANTEED working YouTube videos
courses = [
  {
    id: '1',
    ...
    level: 'Beginner',
    thumbnail: 'https://img.youtube.com/vi/HKSRPmJ8quM/maxresdefault.jpg',
    totalDuration: '8 hours',
    sections: [
      {
        title: 'Introduction to Java',
        description: 'Get started with Java programming basics.',
        videoUrl: 'https://www.youtube.com/watch?v=HKSRPmJquM',
        duration: '45 min',
        order: 1
      },
      {
    ...
    sections: [
      {
        ...
        videoUrl: 'https://www.youtube.com/watch?v=_uQrJ0RZ44w',
        duration: '40 min',
        order: 1
      },
      {
...
app.listen(PORT, () => {
  ...
  console.log('Working server with verified YouTube videos');
});
